...
public class PatientRecord {
    ...
    public PatientRecord(String patientID, String fName, String lName, String dob, int age, String sex,
    ...
    public void addtoHistory(String medHistory) {
        if (medHistory == null || medHistory.trim().isEmpty())
            return;
        this.treatmentRecord.addFirst(medHistory);
        updateModified();
    }

    public void displayMedicalHistory() {
        System.out.println("\u001B[34m---->>\u001B[0m Medical History \u001B[34m<<----\u001B[0m");
        sortMedicalHistory();
        ...
        System.out.println();
        System.out.println("\u001B[34m---->>\u001B[0m Treatment Records (most recent first) \u001B[34m<<----\u001B[0m");
